...
public sealed class ListUsersHandler(IUnitOfWork unitOfWork)
{
    ...
    public async Task<PaginatedListResponse<ListUsersResponse>> Execute(PaginationParametersRequest paginationParameters, CancellationToken cancellationToken = default)
    {
        ...
        return new PaginatedListResponse<ListUsersResponse>(userResponses, count, paginationParameters.PageNumber, paginationParameters.PageSize);
    }
}
