...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM `__EFMigrationsHistory` WHERE `MIGRATION_ID` = '20250622064524_InitialCreate') THEN
...
BEGIN
    ...
    CREATE TABLE `ROLE` (
        `ID` VARCHAR(36) CHARACTER SET utf8mb4 NOT NULL,
        `NAME` VARCHAR(150) CHARACTER SET utf8mb4 NOT NULL,
        `USER_ID` VARCHAR(36) CHARACTER SET utf8mb4 NULL,
        `UPDATED_DATE` DATETIME NOT NULL,
        CONSTRAINT `PK_ROLE` PRIMARY KEY (`ID`),
        CONSTRAINT `FK_ROLE_USERS_USER_ID` FOREIGN KEY (`USER_ID`) REFERENCES `USER` (`ID`) ON DELETE RESTRICT
    ) CHARACTER SET=utf8mb4;
...
BEGIN
    ...
    VALUES ('20250622064524_InitialCreate', '8.0.13');
