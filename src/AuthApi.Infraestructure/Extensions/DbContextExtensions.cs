...
public static class DbContextExtensions
{
    ...
    public static void SeedData(this ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Role>().HasData(
            new Role { Id = adminRoleId, Name = "ADMIN", Code = "A", UpdatedDate = DateTime.UtcNow },
            new Role { Id = userRoleId, Name = "USER", Code = "U", UpdatedDate = DateTime.UtcNow },
            new Role { Id = managerRoleId, Name = "MANAGER", Code = "M", UpdatedDate = DateTime.UtcNow }
        );
        ...
        var managerUserId = Guid.Parse("66666666-6666-6666-6666-666666666666");
        ...
        modelBuilder.Entity<UserRole>().HasData(
            ...
            new UserRole { Id = Guid.Parse("99999999-9999-9999-9999-999999999999"), IdUser = managerUserId, IdRole = managerRoleId },
            new UserRole { Id = Guid.Parse("AAAAAAAA-AAAA-AAAA-AAAA-AAAAAAAAAAAA"), IdUser = managerUserId, IdRole = userRoleId }
        );
    }
}
